    ...
    <div className="slide-container">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <FadeInUp delay={0.3}>
          <div
            ref={cardRef}
            className="card-theme p-10 space-y-6 text-center relative overflow-hidden"
          >
            ...
            <div className="relative z-10 space-y-6">
              <div className="space-y-2">
                <h3 className="text-5xl font-header font-bold text-primary">
                  {data.year}
                </h3>
                <p className="text-2xl text-foreground">DevWrapped</p>
              </div>
